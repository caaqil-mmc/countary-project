...
const Sidebar = () => {
  return (
    <div className='h-screen sticky top-0 flex items-center justify-center  w-24'>
        <div className='bg-primary flex flex-col gap-4 rounded-full p-4 '>
            <button className='w-11 h-11 flex justify-center items-center font-bold uppercase border-b text-white mt-4 rounded-lg hover:bg-gray-50/10 '>
                af
            </button>
